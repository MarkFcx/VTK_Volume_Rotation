...
// ./rotationFunction -DICOM /home/cxfeng/Desktop/My_Work/DicomData/12
=========================================================================*/
// VTK includes
...
//
    string dirP = "/home/cxfeng/Desktop/My_Work/BinaryData/102M/pelMaskSeg2.bin";
...
//
    ...
    unsigned char *U_charArray_L = new unsigned char[size];
    char *binArray_L = new char[size];
    ...
    vtkSmartPointer<vtkImageData> LeftImagedata =
            vtkSmartPointer<vtkImageData>::New();
    LeftImagedata->SetDimensions(512, 512, 600);
...
//
    ...
    string dirR = "/home/cxfeng/Desktop/My_Work/BinaryData/102M/leftMaskSeg2.bin";
...
//
    ...
    volume21->SetMapper(mapper22);
    volume31->SetMapper(mapper32);
    volume41->SetMapper(mapper41);


    volume1->SetMapper(mapper12);
    volume2->SetMapper(mapper22);
    volume3->SetMapper(mapper32);
    volume4->SetMapper(mapper42);
...
//Rotation
    ...
    trans1->Translate(155, 211.188, 83);
    volume1->SetUserTransform(trans1);
    t1 = clock() - t1;
    ...
    trans2->Translate(155, 211.188, 83);
    volume2->SetUserTransform(trans2);
    t2 = clock() - t2;
    ...
    // trans3->Translate(163.947, 255.421, 166.661);
    volume3->SetUserTransform(trans3);
    t3 = clock() - t3;
    ...
    trans4->Translate(340.088, 251.34, 157.613);
    volume4->SetUserTransform(trans4);
    t4 = clock() - t4;
...
//
    ...
    volume21->SetProperty(property);
    volume31->SetProperty(property);
    volume41->SetProperty(property4);

    volume1->SetProperty(property);
    volume2->SetProperty(property2);
    volume3->SetProperty(property3);
    volume4->SetProperty(property4);
...
// Create the renderer, render window and interactor
    ...
    //renderer2->AddVolume( volume1 );
    //renderer2->AddVolume( volume2 );
    //renderer2->AddVolume( volume3 );
    //renderer2->AddVolume( volume4 );
